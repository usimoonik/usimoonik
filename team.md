...
All responsibilities are **very narrowly limited** to only the following areas: technical smart contract deployment and verification, open-source code maintenance, public documentation writing, website content accuracy, transparency updates, and educational explanation of how the token works on-chain. **No team member has any financial authority or control over user assets**.

This structure is deliberately kept minimal to eliminate any possible confusion about the project's purely educational and transparency-focused purpose.

3. Founder & Project Owner – Full Public Disclosure
Name: usi moonik
Role: Project Founder, Smart Contract Deployer, Domain & Website Owner, Primary Official Contact Point, Overall Project Accountability Holder

The founder is responsible for:

Initial creation and deployment of the USI smart contract on BNB Smart Chain
Verification of the source code on BscScan (completed and public since 2025-12-04)
Ownership and maintenance of the official domain and website
Serving as the main public contact for any transparency or technical questions
Ensuring the project remains strictly educational with no financial promises
Important repeated limitations: The founder has **no control** over user wallets, user balances, token supply (fixed forever), or any economic mechanics. The contract owner privilege is extremely limited and cannot mint, burn, freeze, tax, seize, or alter the token in any way.

Contact & Verification Links (all publicly verifiable):

🌐 Official Website: https://usimoonik.com
📧 Official Email: usi@usimoonik.com
🔍 BscScan Verified Contract (live on-chain proof): View Verified Contract & Source Code
Anyone can independently confirm the deployment transaction, ownership status, and code immutability directly on BscScan — no trust in the founder is required beyond what the blockchain publicly shows.

4. Core Team Members – Extremely Detailed Roles, Limitations & Public Profiles
Every core contributor has **very clearly defined and strictly limited duties**. No one has broad powers. All profiles are public, active in the Web3 space, and verifiable (think of them as equivalents to LinkedIn in traditional industries — in blockchain, X, GitHub, Telegram, Medium, and Bitcointalk are standard ways developers and contributors prove identity and work).

Amob Animo – Technical Developer & Smart Contract Maintainer
Detailed Responsibilities:

Assisted with smart contract final review before deployment
Performed independent code audits for security and simplicity
Maintains open-source GitHub repositories related to the project
Provides technical explanations and helps clarify contract behavior for educational purposes
Ensures ongoing transparency by linking all work to public verifiable sources
Strict Authority Limitations (cannot do these):

No minting, burning, or supply change capability
No control or visibility into any user balances or wallets
No access to any private keys or funds
No ability to add/remove taxes, fees, reflections, or blacklists
No authority to conduct fundraising, sales, or financial operations
No contract ownership or upgrade rights
Public Professional Profiles (all clickable & verifiable):

🐦 X (primary public profile & announcements): https://x.com/amobanimo
...
Prepares and maintains all public documentation (about page, team page, terms, etc.)
...
7. Official Verification Channels – Always Check These
